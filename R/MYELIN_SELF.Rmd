...
writeMat("./DATA/INT_halfwidth_detrended_datatable.mat", Regwise = RegWise)
...
RegWise_DESC <- annotate_figure(
  RegWise_DESC,
  top = text_grob(
    "Subjects are averaged to regions",
    color = "black",
    face = "bold",
    size = 14
  )
...
# Create a data frame and combine variables
...
plot_data <- data.frame(
  ...
  Group = factor(
    rep(c("SELF", "NONSELF"), each = nrow(data_ACW)),
...
PAIR <- annotate_figure(
  PAIR,
  top = text_grob(
    "Regions are averaged to subjects",
    color = "black",
    face = "bold",
    size = 14
  )
...
plot1 <- readPNG("~/MYELIN/FIGURES/bp_dt_subj.png")
plot2 <- read_webp("~/MYELIN/FIGURES/dalle.webp")

gl <- list(gimmick, FIG_1, rasterGrob(plot1), rasterGrob(plot2))


png("~/MYELIN/FIGURES/arranged_plot.png",width = 36, height = 27, res = 300, units = "cm")
