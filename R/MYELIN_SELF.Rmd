...
plot1 <- readPNG('./FIGURES/bp_dt_subj.png')
plot2 <- read_webp("./FIGURES/dalle.webp")

gl = list(gimmick, FIG_1, rasterGrob(plot1), rasterGrob(plot2) )


png("./FIGURES/arranged_plot.png",width = 36, height = 27, res = 300, units = "cm")
...
# plot1 <- readPNG("./FIGURES/Global_Dist_bp_dt.png")
# plot2 <- readPNG("./FIGURES/Self_NonSelf_bp_dt.png")
# gl = list( rasterGrob(plot1), rasterGrob(plot2) )
# 
# 
# png("./FIGURES/FIG_2.png",width = 36, height = 27, res = 300, units = "cm")
# 
# grid.arrange(
#   grobs = gl,
#   widths = c(1,1),
...
knitr::include_graphics("./FIGURES/Global_Dist_bp_dt.png")
```
...
knitr::include_graphics("./FIGURES/Self_NonSelf_bp_dt.png")
```
...
file2 <- "./FIGURES/linear.png"
#file3 <- "E:/EIB/FIGURES/mediated.png"
file3 <- "./FIGURES/mediated.png"
file4 <- "./FIGURES/prior_l.png"
file5 <- "./FIGURES/prior_m.png"
file6 <- "./FIGURES/ceoftab_bp_dt.png"
file7 <- "./FIGURES/self_residual.png"
file8 <- "./FIGURES/nonself_residual.png"
...
png("./FIGURES/FIG_3.png", width = 3040, height = 2320, res = 150)

plot(last2)
text(x = 50, y = 2280, labels = "(A)", xpd = NA, cex=1.8, font=2)
text(x = 1595, y = 2280, labels = "(B)", xpd = NA, cex=1.8, font=2)
text(x = 50, y = 1500, labels = "(D)", xpd = NA, cex=1.8, font=2)
text(x = 700, y = 1500, labels = "SELF", xpd = NA, cex=1.8, font=2)
text(x = 1595, y = 1500, labels = "(E)", xpd = NA, cex=1.8, font=2)
...
```{r}
library(magick)
file1 <- "./FIGURES/rho_corr_bp_dt.png"
file2 <- "./FIGURES/myacw_bp_dt.png"
file3 <- "./FIGURES/mygs_bp_dt.png"
file4 <- "./FIGURES/counterfacted_bp_dt.png"
file5 <- "./FIGURES/priorsubj.png"
file6 <- "./FIGURES/all2gs_bp_dt.png"
file7 <- "./FIGURES/medGS.png"
...
FIG_4 <- image_append(c(merged_image_1, merged_image_2), stack = TRUE)

png("./FIGURES/FIG_4.png", width = 3040, height = 2320, res = 150)

plot(FIG_4)
text(x = 50, y = 1350, labels = "(A)", xpd = NA, cex=1.8, font=2)
text(x = 350, y = 1350, labels = "(B)", xpd = NA, cex=1.8, font=2)
text(x = 650, y = 1350, labels = "(C)", xpd = NA, cex=1.8, font=2)
text(x = 950, y = 1350, labels = "(D)", xpd = NA, cex=1.8, font=2)
