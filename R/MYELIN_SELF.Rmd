...
####### REGION-WISE ##################
test <- readMat("E:/EIB/MATLAB_ClassificationApp/MED.mat")
...
for ( i in 1:100 ) lines( c(-2,2) , M_m[i,] , col=col.alpha("black",0.4), lwd=2  )
...
RowNames <- c("a[nonself]", "a[self]", "bMY[nonself]", "bMY[self]", "sigma", "bACW[nonself]", "bACW[self]" )

rownames(coef@coefs) <- RowNames
coef@coefs <- coef@coefs[c(3,4,6,7),]
